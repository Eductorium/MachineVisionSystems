...
![image](pics3/image5.png)

То же самое можно представить в виде функции максимума (вторая строка на картинке выше).

 Посмотрим на пример с нашими тремя классами:

![image](pics3/image6.png)
...
* **Если все оценки будут примерно равны нулю и примерно равны между собой, чему будут равны потери?**
    ...
    _Ответ: значение потерь будет на единицу меньше, чем число классов. Не забудьте, что помимо sj − syi есть ещё + 1._

* **Как изменятся потери, если суммировать все оценки, включая истинную метку yi?**

    _Ответ: увеличатся на единицу, потому что syi − syi  + 1 = 1._
...
![image](pics3/image17.png)

#### Эластичная сеть

Это комбинация регуляризаций L1 и L2:

![image](pics3/image18.png)
